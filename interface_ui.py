...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "PAPPL"))
        self.label.setText(_translate("Form", "<div style=\"font-weight:normal;font-variant:small-caps;color:#353535;letter-spacing:1pt;word-spacing:2pt;font-size:15px;text-align:center;font-family:trebuchet MS, sans-serif;line-height:2;margin:0px;padding:0px;\">Affichage de graphe grâce à Cytoscape</div>"))
        ...
        self.label_2.setText(_translate("Form", "<div style=\"font-weight:normal;font-variant:small-caps;color:#353535;letter-spacing:1pt;word-spacing:2pt;font-size:15px;text-align:center;font-family:trebuchet MS, sans-serif;line-height:2;margin:0px;padding:0px;\">Réduction de graphes</div>"))
        ...
        self.label_3.setText(_translate("Form", "<div style=\"font-weight:normal;font-variant:small-caps;color:#353535;letter-spacing:1pt;word-spacing:2pt;font-size:15px;text-align:center;font-family:trebuchet MS, sans-serif;line-height:2;margin:0px;padding:0px;\">Coloration du graphe réduit grâce à IGGY-poc</div>"))
        self.load_3.setText(_translate("Form", "Charger un graphe"))
        self.color.setText(_translate("Form", "Colorer le graphe"))
