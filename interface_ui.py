...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(509, 358)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("pageHeaderLogoImage_en_US.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-family:\'trebuchet MS,sans-serif\'; font-size:15px; color:#353535; font-variant:small-caps;\">Affichage de graphe grâce à Cytoscape</span></p></body></html>"))
        ...
        self.label_2.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-family:\'trebuchet MS,sans-serif\'; font-size:15px; color:#353535; font-variant:small-caps;\">Réduction de graphes</span></p></body></html>"))
        ...
        self.label_3.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-family:\'trebuchet MS,sans-serif\'; font-size:15px; color:#353535; font-variant:small-caps;\">Coloration du graphe réduit grâce à IGGY-poc</span></p></body></html>"))
        self.label_4.setText(_translate("Form", "<html><body><p align=\"center\">Temps d\'exécution maximal :</p></body></html>"))
